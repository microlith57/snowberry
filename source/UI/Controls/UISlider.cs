...
public class UISlider : UIElement {
    ...
    public override void Update(Vector2 position = default) {
        ...
        var hoveringTrack = track.Contains(Mouse.Screen.ToPoint());

        if ((hovering || hoveringTrack) && ConsumeLeftClick())
            pressed = true;
    ...
    protected Rectangle TrackRect() => new(Bounds.X, Bounds.Y + (int)(Height / 2f) - (int)(TrackThickness / 2f), Width, TrackThickness);
